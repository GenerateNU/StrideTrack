...
import { GroundContactTimeChart, FlightTimeChart, StepTimeChart } from "@/components/charts/TemporalCharts";
...
export default function VisualizationsPage() {
  const { metrics, metricsIsLoading, metricsError, metricsRefetch } = useAthleteRunMetrics(HARDCODED_ATHLETE_ID);

  if (metricsIsLoading) return <QueryLoading />;
  if (metricsError) return <QueryError error={metricsError} refetch={metricsRefetch} />;
