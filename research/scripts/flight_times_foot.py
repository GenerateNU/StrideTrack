...
def main():
    ...
    input_dir = PROJECT_ROOT / "research" / "data" / "processed"
    output_dir = PROJECT_ROOT / "research" / "data" / "processed"
    ...
    for filename in unified_files:
        ...
        output_file = output_dir / filename.replace("_BothFeet.csv", "_FlightTimes.csv")
