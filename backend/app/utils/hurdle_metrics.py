...
def main() -> None:
    ...
    print("Loaded Data from HurdleSensorCombined_TransformedData.csv")
    ...
    print("=" * 60)
    print("HURDLE METRICS")
    print("=" * 60)
    hurdles_df = transform_stride_cycles_to_hurdle_metrics(df)

    print(f"Detected hurdles: {len(hurdles_df)}")
    print()
    print("Per-hurdle metrics:")
    print(hurdles_df)
    print()
    ...
    print("=" * 60)
    if len(hurdles_df) == 0:
        print("No hurdles detected. Try lowering hurdle_min_ft_ms.")
        return
