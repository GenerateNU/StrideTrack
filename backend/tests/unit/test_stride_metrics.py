...
class TestCalculateRsi:
    ...
    def test_empty_returns_empty_with_schema(self, empty_stride_df: pd.DataFrame) -> None:
...
class TestCalculateContactFlightIndex:
    ...
    def test_empty_returns_empty_with_schema(self, empty_stride_df: pd.DataFrame) -> None:
        ...
        assert list(result.columns) == [
            "stride_num", "foot", "ic_time", "contact_flight_index",
        ]
...
class TestCalculateGctAsymmetryPercent:
    ...
    def test_correct_asymmetry_value(self) -> None:
        ...
        assert len(result) == 1
        assert result["gct_asymmetry_percent"].iloc[0] == pytest.approx(9.5238, rel=1e-3)
    ...
    def test_output_columns(self) -> None:
        ...
        assert list(result.columns) == [
            "stride_num", "ic_time", "gct_asymmetry_percent", "gct_left", "gct_right",
        ]
...
class TestCalculateFtAsymmetryPercent:
    ...
    def test_correct_asymmetry_value(self) -> None:
        ...
        assert len(result) == 1
        assert result["ft_asymmetry_percent"].iloc[0] == pytest.approx(18.1818, rel=1e-3)
    ...
    def test_output_columns(self) -> None:
        ...
        assert list(result.columns) == [
            "stride_num", "ic_time", "ft_asymmetry_percent", "ft_left", "ft_right",
        ]
...
class TestCalculateGctDifferenceLr:
    ...
    def test_output_columns(self) -> None:
        ...
        assert list(result.columns) == [
            "stride_num", "ic_time", "gct_diff_lr_ms", "gct_left", "gct_right",
        ]
...
class TestCalculateFtDifferenceLr:
    ...
    def test_output_columns(self) -> None:
        ...
        assert list(result.columns) == [
            "stride_num", "ic_time", "ft_diff_lr_ms", "ft_left", "ft_right",
        ]
...
class TestCalculateAllMetrics:
    ...
    def test_summary_values_are_correct_types(self, two_stride_df: pd.DataFrame) -> None:
    ...
    def test_time_series_values_are_dataframes(self, two_stride_df: pd.DataFrame) -> None:
